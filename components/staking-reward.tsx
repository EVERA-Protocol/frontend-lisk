    ...
    const handleClaimRewards = () => {
        ...
        setTimeout(() => {
            ...
            toast({
                ...
                description: `You have claimed ${totalClaimableRewards.toFixed(2)} tokens worth IDRX ${totalRewardsValue.toFixed(2)}`,
            })
        }, 3000)
    }
        ...
        <div className="space-y-4">
            <div>
                ...
                <div className="text-2xl font-bold text-white">
                    IDRX {totalRewardsValue.toLocaleString(undefined, { maximumFractionDigits: 2 })}
                </div>
                ...
                <DialogContent className="border-cyan-800 bg-black/95">
                    {isClaimingSuccess ? (
                        <TransactionSuccess
                            ...
                            subMessage={`You have claimed ${totalClaimableRewards.toFixed(2)} tokens worth IDRX ${totalRewardsValue.toFixed(2)}`}
                                            ...
                                            <div key={staked.assetId} className="flex items-center justify-between text-sm text-white">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <span className="text-gray-400">
                                                        (IDRX {(staked.claimableRewards * asset.priceUsd).toFixed(2)})
                                                    </span>
                                                </div>
                                            </div>
                                        )
