                ...
                <CardContent>
                    ...
                    <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-4">
                        ...
                        <div className="rounded-lg border border-gray-800 p-3">
                            ...
                            <p className="text-xl font-bold text-white">IDRX 12,450</p>
                        </div>
                        <div className="rounded-lg border border-gray-800 p-3">
                            <p className="text-sm text-gray-400">Sell Volume</p>
                            <p className="text-xl font-bold text-white">IDRX 3,280</p>
                        </div>
                        <div className="rounded-lg border border-gray-800 p-3">
                            <p className="text-sm text-gray-400">Avg. Transaction</p>
                            <p className="text-xl font-bold text-white">IDRX 489</p>
                        </div>
                    </div>
                </CardContent>
            </Card>
