                                                    ...
                                                    <div className="flex items-center justify-between mb-1">
                                                        ...
                                                        <span className="text-sm font-medium text-white">
                                                            ...
                                                            <span className="text-gray-400 ml-1">
                                                                (IDRX {(asset.claimableRewards * asset.priceUsd).toFixed(2)})
                                                            </span>
                                                        </span>
                                                    </div>
                                                            ...
                                                            <DialogContent className="border-cyan-800 bg-black/95">
                                                                {isClaimingSuccess ? (
                                                                    <TransactionSuccess
                                                                        ...
                                                                        subMessage={`You have claimed ${asset.claimableRewards.toFixed(2)} ${asset.symbol} tokens worth IDRX ${(asset.claimableRewards * asset.priceUsd).toFixed(2)}`}
